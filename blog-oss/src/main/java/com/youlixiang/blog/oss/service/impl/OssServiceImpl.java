...
public class OssServiceImpl implements OssService {
     ...
     */
    @Override
    public String uploadOssFile(MultipartFile multipartFile) throws CustomException {
        ...
        try {
            ...
            throw new CustomException(UserErrorEnum.AVATAR_NOT_UPLOAD.getCode(),
                    UserErrorEnum.AVATAR_NOT_UPLOAD.getMessage());
        }
    }
